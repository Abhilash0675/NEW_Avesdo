...
public class TestClosingUnitsWithFilters extends BaseTest {
	...
	public void closingEstimateAndActualWithFilters() throws Exception{
		TestClosingPage testClosingPage = new TestClosingPage(driver,configurationReader, browserName);
		boolean status = testClosingPage.closingEstimatedAndActualCompletionWithFilters();
		handleAssert(status);
	}
